// RTICX Distribution Porting Template -- Proc-macro backend
//
...
//      code-generation hooks that the rticx-core pass calls during expansion.
//
...
use rticx_core::{Analysis, AppArgs, CorePassBackend, RticMacroBuilder, SubAnalysis, SubApp};
#[cfg(feature = "swtasks")]
...
///
/// Reference: `rticx-cortex-m/rtic-macro/src/lib.rs`
///            `rticx-hippo/rtic-macro/src/lib.rs`
...
/// contract from `rticx-core/src/backend.rs`
struct Backend;
...
impl CorePassBackend for Backend {
    ...
    ///   `<your-crate>::export::lock(resource_ptr, CEILING as u8,
    ...
    ///
    /// Reference: `rticx-cortex-m` emits `<your-crate>::export::wfi()`.
...
impl SwPassBackend for SwBackend {
    ...
    ///
    /// Reference: `rticx-cortex-m` uses `<your-crate>::export::NVIC::pend(irq_nbr)`.
    ...
    ///
    /// Reference: `rticx-rp2040` writes `irq_nbr` to the SIO FIFO via
